...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppConfigurationTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function Configuration() {
      ...
      this.ApiPort = "3005"; //this.ApiIP + ":" + this.ApiPort +link
      //getting a sourat /lang

      this.ServerSourat = "/sourat"; //getting a verse in a sourat /lang

      this.ServerVerse = "/verse"; // a word(lang)

      this.ServerWord = "/searchword"; // a word(lang) in sourat
